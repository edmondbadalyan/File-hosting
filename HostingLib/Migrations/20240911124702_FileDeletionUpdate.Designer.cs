...
namespace HostingLib.Migrations
{
    ...
    [Migration("20240911124702_FileDeletionUpdate")]
    partial class FileDeletionUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HostingLib.Data.Entities.User", b =>
                {
                    ...
                    b.Property<TimeSpan>("AutoFileDeletionTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("time")
                        .HasDefaultValue(new TimeSpan(30, 0, 0, 0, 0));
